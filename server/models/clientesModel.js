...
const clienteSchema = new mongoose.Schema({
    tipo: {
        ...
        required: [true, "O cliente tem que ser uma pessoa física ou jurídica."],
    },
    nome: {
        type: String,
        validate: {
        ...
        required: [true, "O cliente precisa de um nome"], //use este modelo para um item obrigatório
        maxlength: [50, "O cliente precisa ter menos de 50 caracteres"], //tamanho max da string
        minlength: [2, "O cliente precisa ter mais de 1 caracteres"], //tamanho min da string
        trim: true,
    },
    email: {
        type: String,
